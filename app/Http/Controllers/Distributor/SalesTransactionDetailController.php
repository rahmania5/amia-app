...
class SalesTransactionDetailController extends Controller
{
    public function index($id, $action=null)
    {
        ...
        if ($action == 'printFaktur') {
            return view('distributor.salesTransaction.printFaktur', compact('salesTransaction', 'printTransactionDetails', 'countPayment'));
        } else if ($action == 'show') {
            return view('distributor.salesTransaction.show', compact('salesTransaction', 'goods', 'salesTransactionDetails'));
        }
    }
    ...
    public function order($id)
    {
        ...
        return redirect()->route('distributor.sales_transaction.index')->with('success', 'Order request sent successfully.');
    }
    ...
    public function finishTransaction($id)
    {
        ...
        return redirect()->route('distributor.sales_transaction.show', ['id'=>$id, 'action'=>'show'])
